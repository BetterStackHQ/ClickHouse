...
#define APPLY_FOR_ACCESS_TYPES(M) \
    ...
    M(SYSTEM_DROP_OBJECT_METADATA_CACHE, "SYSTEM CLEAR OBJECT METADATA CACHE, SYSTEM DROP OBJECT METADATA CACHE, DROP OBJECT METADATA CACHE", GLOBAL, SYSTEM_DROP_CACHE) \
